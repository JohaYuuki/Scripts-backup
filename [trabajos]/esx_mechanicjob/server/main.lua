...
local function Craft(source)
	SetTimeout(4000, function()
		if PlayersCrafting[source] == true then
			...
			local CaroToolQuantity = xPlayer.getInventoryItem('carokit').count
			if CaroToolQuantity >= 3 then
...
RegisterServerEvent('esx_mechanicjob:starfamatCraft')
AddEventHandler('esx_mechanicjob:starfamatCraft', function()
	local _source = source
