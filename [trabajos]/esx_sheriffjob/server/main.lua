...
RegisterServerEvent('esx_sheriffjob:handcuff132')
AddEventHandler('esx_sheriffjob:handcuff132', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'sheriff' then
		TriggerClientEvent('esx_sheriffjob:handcuff132', target)
	else
...
RegisterServerEvent('esx_sheriffjob:buyitem')
AddEventHandler('esx_sheriffjob:buyitem', function(item, price)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
