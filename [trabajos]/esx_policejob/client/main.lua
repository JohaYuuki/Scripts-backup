...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = _U('swat_wear'), value = 'swat_wear' }
	}
	...
	elseif grade == 'subinspector' then
		table.insert(elements, {label = _U('police_wear'), value = 'subinspector_wear'})
	elseif grade == 'inspector' then
		table.insert(elements, {label = _U('police_wear'), value = 'inspector_wear'}) 	
	elseif grade == 'subboss' then
		table.insert(elements, {label = _U('police_wear'), value = 'subboss_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'subinspector_wear' or
			data.current.value == 'inspector_wear' or
			data.current.value == 'subboss_wear' or
...
function OpenPoliceActionsMenu()
	...
	table.insert(elements, {label = _U('balance_bank_money'), value = 'balance_bank_money'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						...
						if distance <= 2.0 then
							...
							ExecuteCommand("me Saca las esposas y se las coloca")
							ExecuteCommand("do Estaria esposado")
						else
					...
					elseif action == 'uncuff' then
						...
						if distance <= 2.0 then
							...
							ExecuteCommand("do Podria moverse con libertad")
						else
		...
		elseif data.current.value == "balance_bank_money" then 
			if PlayerData.job.grade_name == "boss" then
			OpenSocietyMoney(PlayerData.job.name, PlayerData.job.label)
			else
				ESX.ShowNotification("No eres el Comisario de la LSPD (Te estamos observando...)")
			end
		end
	end, function(data, menu)
		menu.close()
...
function OpenSocietyMoney(job, jobLabel)
	...
	ESX.TriggerServerCallback('esx_society:getSocietyMoney', function(money)
		...
		if PlayerData.job.grade_name == "boss" then
			table.insert(elements, {label = "Dinero Sociedad - " .. money})
		end
	
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'society_check', {
			title    = 'Dinero Sociedad - ' .. jobLabel,
			align    = 'bottom-right',
			elements = elements
		...
		'default', GetCurrentResourceName(), 'armory_items_buy',
		  {
			...
			align    = 'top-left',
			elements = {
				{label = 'Pan (15$)', value = 'water_1', item = 'bread', price = 15},
				{label = 'Agua (15$)', value = 'water_1', item = 'water', price = 15},
				{label = 'Localizador (150$)', value = 'water_1', item = 'gps', price = 150},
				{label = 'Cargador (100$)', value = 'water_1', item = 'clip', price = 100},
				{label = 'Chaleco Antibalas (150$)', value = 'water_1', item = 'bulletproof', price = 150},
				{label = 'Analizador de ADN (1500$)', value = 'water_1', item = 'dnaanalyzer', price = 1500},
				{label = 'Analizador de Munición (150$)', value = 'water_1', item = 'ammoanalyzer', price = 1500},
	      }
		},
		function(data, menu)
