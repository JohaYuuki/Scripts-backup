...
function OpenRealestateAgentMenu()
	local elements = {
		{label = 'Tienda', value = 'properties'},
		{label = 'Añadir Item a la tienda',    value = 'customers'},
	}
...
AddEventHandler('gks_gotur:gerisayim', function(gelens, gotur)
  ...
  total = gelens
  bilgi = gotur
  TriggerEvent('gksphone:notifi', {title = 'Yuki', message = _U('gotur_time') .. deliverytime, img= '/html/static/img/icons/gotur.png' })
...
function startTracking(entity, name, number)
    ...
    TriggerEvent('gksphone:notifi', {title = 'Yuki', message = _U('gotur_map') .. deliverytime ..' minutes', img= '/html/static/img/icons/gotur.png' })
